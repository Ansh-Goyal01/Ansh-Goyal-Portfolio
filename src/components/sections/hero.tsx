                ...
                <BlurIn delay={1}>
                  <Tooltip delayDuration={300}>
                    <TooltipTrigger asChild>
                      <h1
                        className={cn(
                          "-ml-[3px] leading-[1.05] text-left",
                          "font-display font-bold tracking-tight",
                          "text-5xl sm:text-6xl md:text-6xl lg:text-7xl xl:text-7xl",
                          "cursor-default"
                        )}
                      >
                        ...
                        <span
                          className={cn(
                            ...
                            "bg-gradient-to-r from-[#7FC8FF] to-[#3776AB]",
                            "drop-shadow-[0_0_28px_rgba(127,200,255,0.35)]"
                          )}
                        >
